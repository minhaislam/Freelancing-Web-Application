...
<html>
   ...
   if(count($get)>0){
	...
	?>
				<tbody>
					<tr>
						<td  colspan="8"><font color="red" size="5"><u><?php echo $user["username"]; ?></u></font> Has sent you a message   <a href="messages.php">View</a>/<a href="dltmessages.php">Delete</a></td>
					</tr>
